...
export default function ProductCard({ product }) {
  ...
  return (
    <>
      ...
      <div
        style={{ height: "450px" }}
        className="w-full bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col"
      >
        <Link to={`/product/${product.id}`} className="flex-1 flex flex-col">
          ...
          <div className="px-4 pb-2 flex-1 flex flex-col">
            ...
            <h3
              style={{ height: "40px" }}
              className="text-sm font-semibold text-gray-800 mb-2 overflow-hidden leading-5"
            >
            ...
            <p
              style={{ height: "48px" }}
              className="text-xs text-gray-500 mb-3 overflow-hidden leading-4"
            >
